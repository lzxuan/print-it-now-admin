<template>
  <div class="pa-2">
    ...
    <p>
      ...
      intellectual property rights related to it, still belong to Triplicity.
    </p>
    <p>
      Triplicity is committed to ensuring that the app is as useful and
    ...
    <p>
      The Print It Now app stores and processes personal data that you have
      ...
      features and it could mean that the Print It Now app won’t work properly
      or at all.
    </p>
    <div>
      <p>
    ...
    <p>
      You should be aware that there are certain things that Triplicity will not
      ...
      provided by your mobile network provider, but Triplicity cannot take
    ...
    <p>
      Along the same lines, Triplicity cannot always take responsibility for the
      ...
      Service, Triplicity cannot accept responsibility.
    </p>
    <p>
      With respect to Triplicity’s responsibility for your use of the app, when
      ...
      available to you. Triplicity accepts no liability for any loss, direct or
    ...
    <p>
      ...
      Triplicity does not promise that it will always update the app so that it
    ...
    <p>
      These terms and conditions are effective as of 18 April 2020.
    </p>
    <p><strong>Contact Us</strong></p>
    <p>
      If you have any questions or suggestions about our Terms and Conditions,
      do not hesitate to contact us at zhixuan218@gmail.com,
      brandonchua17@gmail.com, or polypac130@gmail.com.
    </p>
  </div>
</template>
