<template>
  <div class="pa-2">
    ...
    <p>
      Triplicity built the Print It Now app as a Free app. This SERVICE is
      provided by Triplicity at no cost and is intended for use as is.
    </p>
    <p>
    ...
    <p>
      ...
      Terms and Conditions, which is accessible at Print It Now unless otherwise
    ...
    <p>
      ...
      not limited to full name, email address, and phone number. The information
    ...
    <p>This policy is effective as of 18 April 2020.</p>
    <p><strong>Contact Us</strong></p>
    <p>
      If you have any questions or suggestions about our Privacy Policy, do not
      hesitate to contact us at zhixuan218@gmail.com, brandonchua17@gmail.com,
      or polypac130@gmail.com.
    </p>
  </div>
</template>
